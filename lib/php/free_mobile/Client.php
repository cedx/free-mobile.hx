...
class Client {
	...
	public function sendMessage ($text) {
		...
		return Promise_Impl_::_new(function ($resolve, $reject) use (&$url, &$_gthis, &$http) {
			$_gthis->onRequest(new RequestEvent("request", $_gthis, $url));
			$http->onBytes = function ($bytes) use (&$url, &$resolve, &$_gthis) {
				$_gthis->onResponse(new RequestEvent("response", $_gthis, $url));
				$resolve(null);
			};
